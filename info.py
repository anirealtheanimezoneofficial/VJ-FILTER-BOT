...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7273593616 6069621485').split()] # For Multiple Id Use One Space Between Each.
